...
export default async function Chapter({ params }) {
    ...
    return (
        <div className="w-full md:w-[75%] m-auto bg-[#f7f4e9] px-4 md:px-5 my-5 py-10">
            {/* Chapter Title */}
            <h2 className="my-4 text-center text-blue-900 font-serif text-3xl md:text-4xl font-bold italic">
                {data.chapter_name}
            </h2>

            {/* Chapter Content */}
            <div className="prose prose-lg md:prose-xl mx-auto text-justify leading-relaxed">

...
import { resultUpdatePublishedStatus } from '@/constans';
import { contextD } from '@/contextApi/DashboardState';
import { CheckCircle, HelpCircle, Image as ImageIcon, Save, Edit3 } from 'lucide-react';
import Image from 'next/image';
import { useRouter } from 'next/navigation';
import React, { useContext, useEffect, useState } from 'react';

export default function ResultDetails({ writtenResultData, isAdmin, resultId }) {
    ...
    const publishedResult = async () => {
        ...
        try {
            ...
            const payload = {
                method: "PUT",
                api: resultUpdatePublishedStatus + resultId,
                body: marks
            };

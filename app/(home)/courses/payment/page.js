...
export default function ManualPaymentPage() {
    ...
    const [courseInfo, setCourseInfo] = useState({ id: "", amount: "" });
                        ...
                        <div className="mt-8 p-5 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                            ...
                            <ul className="text-xs text-slate-600 space-y-3">
                                <li className="flex gap-3 leading-relaxed">
                                    ...
                                    বিকাশ, নগদ বা রকেট অ্যাপ থেকে উপরে দেওয়া নাম্বারে {courseInfo.amount || "0.00"} টাকা পাঠিয়ে দিন।
                                </li>
                                <li className="flex gap-3 leading-relaxed">
